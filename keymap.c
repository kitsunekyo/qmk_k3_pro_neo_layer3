...
// activate caps word by pressing left_shift and right_shift at the same time
...
[WIN_BASE] = LAYOUT_iso_85(
     ...
     KC_GRV,       KC_1,        KC_2,     KC_3,     KC_4,     KC_5,     KC_6,     KC_7,     KC_8,     KC_9,     KC_0,     KC_MINS,    KC_EQL,   KC_BSPC,             KC_PGUP,
     KC_TAB,       KC_Q,        KC_W,     KC_E,     KC_R,     KC_T,     KC_Y,     KC_U,     KC_I,     KC_O,     KC_P,     KC_LBRC,    KC_RBRC,  KC_ENT,              KC_PGDN,
     MO(WIN_L3),   KC_A,        KC_S,     KC_D,     KC_F,     KC_G,     KC_H,     KC_J,     KC_K,     KC_L,     KC_SCLN,  KC_QUOT,              LT(WIN_L3, KC_BSLS), KC_HOME,
     KC_LSFT,      KC_NUBS,     KC_Z,     KC_X,     KC_C,     KC_V,     KC_B,     KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,              KC_RSFT,   KC_UP,    KC_END,
